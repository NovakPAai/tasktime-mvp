...
const DARK_C = {
  ...
  accentClosed:  '#484F58',
  badgeActiveBg:   'rgba(74, 222, 128, 0.12)',
  badgeActiveText: '#4ADE80',
  badgePlannedBg:   'rgba(72, 79, 88, 0.20)',
  badgePlannedText: '#8B949E',
  badgeClosedBg:    'rgba(72, 79, 88, 0.20)',
...
const LIGHT_C = {
  ...
  green:       '#1A7F37',
  accentActive:  '#1A7F37',
  accentPlanned: '#9198A1',
  accentClosed:  '#9198A1',
  badgeActiveBg:   'rgba(26, 127, 55, 0.10)',
  badgeActiveText: '#1A7F37',
  badgePlannedBg:   'rgba(145, 152, 161, 0.12)',
  badgePlannedText: '#656D76',
  badgeClosedBg:    'rgba(145, 152, 161, 0.12)',
  badgeClosedText:  '#9198A1',
  progressBg:  '#E8EBF0',
