...
| 12 | `ttbulk-1/e2e-docs-cutover`     | Playwright + k6 + docs + feature-flag flip + IssueDetailPage badge | 10 | PR-5, PR-7, PR-8, PR-11 | e2e + docs + cutover | 🟢 Merged (#156) |
| 13 | `ttbulk-1/metrics`              | Prometheus metrics + grafana dashboard + alerts              | 4    | PR-12 (параллель) | metrics + alerts   | 🟢 Merged (#155) |
