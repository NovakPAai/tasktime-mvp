...
router.get('/', authHandler(async (_req, res) => {
...
router.post('/', validate(createCheckpointTemplateDto), authHandler(async (req, res) => {
...
router.patch('/:id', validate(updateCheckpointTemplateDto), authHandler(async (req, res) => {
