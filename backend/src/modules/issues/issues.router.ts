...
router.get('/issues/search', authHandler(async (req, res) => {
...
router.get('/projects/:projectId/issues', asyncHandler(async (req, res) => {
...
router.get('/mvp-livecode/issues/active', asyncHandler(async (req, res) => {
...
router.post('/projects/:projectId/issues', validate(createIssueDto), authHandler(async (req, res) => {
...
router.get('/issues/key/:key', authHandler(async (req, res) => {
...
// Get issue detail
router.get('/issues/:id', authHandler(async (req, res) => {
...
// Update issue
router.patch('/issues/:id', validate(updateIssueDto), authHandler(async (req, res) => {
...
// Change status
router.patch('/issues/:id/status', validate(updateStatusDto), authHandler(async (req, res) => {
  const existing = await issuesService.getIssue(req.params.id as string);
  await requireIssueAccess(req, existing.projectId);
...
// Change issue type
router.patch('/issues/:id/change-type', validate(changeTypeDto), authHandler(async (req, res) => {
  const existing = await issuesService.getIssue(req.params.id as string);
  await requireIssueAccess(req, existing.projectId);
...
router.post('/issues/:id/move', validate(moveIssueDto), authHandler(async (req, res) => {
  const existing = await issuesService.getIssue(req.params.id as string);
  await requireIssueAccess(req, existing.projectId);
...
// Delete issue
router.delete('/issues/:id', requireRole('ADMIN', 'SUPER_ADMIN'), authHandler(async (req, res) => {
...
// Get children
router.get('/issues/:id/children', authHandler(async (req, res) => {
  const issue = await issuesService.getIssue(req.params.id as string);
  await requireIssueAccess(req, issue.projectId);
...
router.get('/issues/:id/history', authHandler(async (req, res) => {
  const issue = await issuesService.getIssue(req.params.id as string);
  await requireIssueAccess(req, issue.projectId);
